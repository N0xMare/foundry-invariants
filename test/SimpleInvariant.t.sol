...
contract SimpleInvariantTest is Test, InvariantTest {
    ...
    function setUp() public {
        ...
        //without targeting the SimpleInvariant contract the invariant test will traverse across all the contracts in src/
        //because no scope has been defined in setUp() using targetContract()/targetContracts() among others
    ...
    /*
    * After the setUp() function is run, the state of the target contract is taken in this case. There after
    ...
    * what setFoo() and setBar() do to make the invariant fail and you will see forge test outputs specific call chains that make it fail.
    */
